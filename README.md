...
## 🛠️ Tech Stack
* **Core Engine:** Google Gemini AI (with custom LLM Wrapper).
* **LangChain** – Manages prompt templates and conversation memory.
* **Gradio** – Provides a sleek, responsive chat UI for real-time interaction.
